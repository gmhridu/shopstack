...
export function ShippingMethodSelector() {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <div className="relative flex items-center space-x-3 rounded-lg borde border-input p-4 transition-colors hover:border-primary/50 has-data-state-checked:border-primary">
