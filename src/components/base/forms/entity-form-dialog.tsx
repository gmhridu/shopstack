        ...
        >
          {(fieldState) => (
            <UIField>
              ...
              <FileUploaderRegular
                key={field.name + (open ? "open" : "closed")}
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className={cn(
          ...
          scrollable &&
            "h-[85vh] flex flex-col overflow-hidden custom-scrollbar min-h-0",
        )}
      >
        <DialogHeader>
          <DialogTitle>
        ...
        <Form
          ...
          className={cn(
            "space-y-4",
            scrollable &&
              "flex flex-col flex-1 overflow-hidden custom-scrollbar min-h-0",
          )}
        >
          <div
            className={cn(
