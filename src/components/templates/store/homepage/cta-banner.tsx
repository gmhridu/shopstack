...
export function CtaBanner() {
  return (
    <Section
      ...
      description="Don't miss out - exprience the epitome of fashion by clicking 'Buy Now' and embrace a world of chic elegance delivered to your doorstep. Your style journey begins here."
      containerClassName="bg-primary-70 border-transparent"
      rightAsset={
        <BallCircleIcon className="@5xl:h-79 @6xl:h-96.5 h-24 @5xl:w-75.25" />
      }
