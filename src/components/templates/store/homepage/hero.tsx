...
export function Hero() {
  ...
  return (
    <section className="@container container mx-auto space-y-8 px-4 pt-15">
      <div className="relative rounded-2xl border border-dashed">
        <div className="relative">
          ...
          <div className="-translate-x-1/2 -bottom-12 absolute left-1/2">
            <div className="relative flex h-23.5 w-49.5 items-center justify-center rounded-2xl bg-background">
        ...
        <div className="grid @4xl:grid-cols-2 grid-cols-1 gap-8">
          <div className="space-y-8 @4xl:p-12 @6xl:p-15 @7xl:p-20 p-3 pt-14">
