...
import { requiredShopAccess } from "#/lib/helper/vendor";
import { executeCategoryQuery, fetchCategoryWithRelations } from "#/lib/helper/category-query-helper";
...
export const getCategories = createServerFn({ method: "GET" })
  ...
  .handler(async ({ context, data }): Promise<CategoryListResponse> => {
    ...
    await requiredShopAccess(userId, shopId);
